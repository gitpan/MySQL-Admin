...
$MySQL::Admin::Settings::VERSION = '0.44';
...
sub getSelf {
    ...
    ) ? @_ : ( $MySQL::Admin::Settings::DefaultClass->new, @_ );
}

=head2 see Also

L<CGI> L<MySQL::Admin::Actions> L<MySQL::Admin::Translate> L<MySQL::Admin::Settings> L<MySQL::Admin::Config>
