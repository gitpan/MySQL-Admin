$VAR1 = [
    ...
    {  'text'    => 'Examples',
       ...
       'subtree' => [
           {  'text' => 'HTML::Window',
              'href' =>
                  'http://lindnerei.de/cgi-bin/examples/window.pl'
           },
           {  'text' => 'HTML::Editor',
              'href' =>
                  'http://lindnerei.de/cgi-bin/examples/editor.pl'
           },
           {  'text' => 'HTML::TabWidget',
              'href' =>
                  'http://lindnerei.de/cgi-bin/examples/tabwidget.pl'
           },
           {  'text' => 'HTML::Menu::Pages',
              'href' =>
                  'http://lindnerei.de/cgi-bin/examples/pages.pl'
           },
           {  'text' => 'MySQL::Admin::Main',
              'href' =>
                  'http://lindnerei.de/cgi-bin/examples/main.pl'
           },
           {  'text' => 'DBI::Libary FO Syntax',
              'href' =>
                  'http://lindnerei.de/cgi-bin/examples/DBI-FO.pl'
           },
           {  'text' => 'DBI::Libary OO Syntax',
              'href' =>
                  'http://lindnerei.de/cgi-bin/examples/DBI-OO.pl'
           },
       ],
    },
];
